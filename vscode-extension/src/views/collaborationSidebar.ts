 ...
 */
export class CollaborationSidebarProvider
  implements vscode.TreeDataProvider<CollaborationTreeItem>
{
  private _onDidChangeTreeData: vscode.EventEmitter<
    CollaborationTreeItem | undefined | null
  > = new vscode.EventEmitter<CollaborationTreeItem | undefined | null>();
  ...
  async getChildren(
    element?: CollaborationTreeItem,
  ): Promise<CollaborationTreeItem[]> {
