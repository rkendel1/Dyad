 ...
 */
export class DyadSidebarProvider
  implements vscode.TreeDataProvider<DyadTreeItem>
{
  private _onDidChangeTreeData: vscode.EventEmitter<
    DyadTreeItem | undefined | null | void
  > = new vscode.EventEmitter<DyadTreeItem | undefined | null | void>();
