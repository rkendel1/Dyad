...
const logger = log.scope("portal_service");

/**
 * Parameters for creating a migration
 */
export interface MigrateCreateParams {
  appId: number;
}
...
/**
 * Service class for managing Portal operations
 */
export class PortalService {
  /**
   * Get an app by ID
   */
  private async getApp(appId: number) {
