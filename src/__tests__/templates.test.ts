...
describe("Templates", () => {
  it("should have the default template", () => {
    const defaultTemplate = localTemplatesData.find(
  ...
  it("should include new Stripe template", () => {
    const stripeTemplate = localTemplatesData.find(
      (t) => t.id === "stripe-ecommerce",
    );
  ...
  it("should include new dashboard template", () => {
    const dashboardTemplate = localTemplatesData.find(
      (t) => t.id === "dashboard-admin",
    );
  ...
  it("should include new contentful blog template", () => {
    const contentfulTemplate = localTemplatesData.find(
      (t) => t.id === "contentful-blog",
    );
  ...
  it("should include new medusa ecommerce template", () => {
    const medusaTemplate = localTemplatesData.find(
      (t) => t.id === "medusa-ecommerce",
    );
