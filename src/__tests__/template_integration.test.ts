...
import { getAllTemplates, getTemplateOrThrow } from "../ipc/utils/template_utils";
...
describe("Template Integration", () => {
  ...
  it("should throw error for non-existent template", async () => {
    await expect(getTemplateOrThrow("non-existent-template"))
      .rejects
  ...
  it("should maintain template diversity", async () => {
    ...
    const hasEcommerce = templates.some(t => 
    ...
    const hasBlog = templates.some(t => 
