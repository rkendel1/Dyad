      ...
      const errorScenarios = [
        {
          ...
          message: 'Docker is not installed or not running. Please install Docker Desktop and ensure it\'s running.',
        },
        {
          type: 'timeout',
        ...
        },
        {
          ...
          message: 'Permission denied starting Docker containers. Please ensure:',
        },
      ];
